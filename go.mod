module github.com/sujoshua/caddy-logger-loki
...
require (
	...
	github.com/grafana/pyroscope-go/godeltaprof v0.1.8 // indirect; this should be indirect, but we should do this to fix https://github.com/grafana/pyroscope-go/issues/117
